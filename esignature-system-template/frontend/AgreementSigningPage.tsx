                            ...
                            <Card style={{ backgroundColor: 'var(--gray-1)' }}>
                                <Flex direction="column" gap="3">
                                    <Box>
                                        ...
                                        <Text size="3">Marketing & Advertising Services</Text>
                                    </Box>
                                    <Box>
                        ...
                        <Box>
                            ...
                            <Card style={{ backgroundColor: 'var(--gray-1)', maxHeight: '300px', overflow: 'auto' }}>
                                <Text size="2" style={{ lineHeight: 1.6 }}>
                                    <strong>1. Services:</strong> Provider agrees to provide marketing and advertising services as outlined in the campaign details.<br/><br/>
